    ...
    return (
        <main id="home" style={ transition && transition.style }>
            ...
            <Container>
                ...
                <p>We serve most electrical installation needs and our customers include homeowners, architects, designers, offices, shops and factories.</p>
                ...
                We have a broad range of electrical services covering all <Link to={'/services/commercial'}>commercial</Link> and <Link to={'/services/domestic'}>domestic</Link> requirements.</p>
